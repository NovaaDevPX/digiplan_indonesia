    ...
    <main class="ml-64 p-10 w-full flex-1">
      <div class="max-w-7xl mx-auto">
        ...
        <div class="flex justify-between items-center mb-6">
          ...
          <a href="distribution-add.php" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white rounded-xl shadow-lg transform hover:scale-105 transition-all duration-200">
